...
import com.third.trading.bean.request.LoginRequest;
import com.third.trading.bean.request.OperationUserListRequest;
import com.third.trading.bean.request.RegisterRequest;
import com.third.trading.bean.response.UnifiedResult;
import com.third.trading.bean.response.UnifiedResultBuilder;
import com.third.trading.service.IOperationUserService;
import com.third.trading.service.security.JwtUser;
import com.third.trading.service.security.OperationUserHelper;
import com.third.trading.service.security.OperationToken;
import com.third.trading.util.Constants;
import com.third.trading.util.ErrorUtil;
...
public class OperationUserController {
    ...
    public UnifiedResult userRegister(@RequestBody RegisterRequest registerRequest){
        ...
        com.third.trading.bean.OperationUser auditingUserByNumber = operationUserService.findUserByAccount(registerRequest.getAccount());
        ...
        com.third.trading.bean.OperationUser operationUser = new com.third.trading.bean.OperationUser();
    ...
    public UnifiedResult edit(@Valid OperationUser operationUser,
        ...
        if (operationUser.getId() == null || operationUser.getId() == 0) {
            com.third.trading.bean.OperationUser operationUserByAccount = operationUserService.findUserByAccount(operationUser.getAccount());
    ...
    public UnifiedResult list(OperationUserListRequest request) {
        List<com.third.trading.bean.OperationUser> operationUserList = operationUserService.listOperationUser(request);
